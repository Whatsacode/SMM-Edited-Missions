//BotMission configuration go to line 481!!!

class PlaneCrashSideMission extends SideMissions
{
	...
	ref array<vector> AISpawns = new array<vector>;
	...
	void PlaneCrashSideMission()
	{
		...
		//individual AI spawnpoints
		AISpawns.Insert("0 -4.5 -3");
	...
	{
		//Despawn MissionBots
		//delete m_BotMInstanceDynamicSMM;
	...
	{	
		...
		//Spawn individual AI "SurvivorAI_Harris"
		//m_SurvivorAI = SurvivorAI_Base.Cast( GetGame().CreateObject("SurvivorM_Oliver", CrashedC130.ModelToWorld( AISpawns.Get(0) )));
		//m_SurvivorAI.SetPosition( CrashedC130.ModelToWorld( AISpawns.Get(0) ));
		//Spawn MissionGuards
