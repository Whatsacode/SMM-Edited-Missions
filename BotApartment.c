class   BotApartmentMission extends SurvivorMissions
{
	...
	ref array<vector> patrol_101 = {"21 0 0","0 0 -21","-21 0 0","0 0 21","21 0 0"};
...
/////////////////////////////////////////////////////////////////////////////////////
...

	{
		...
		foreach (int w, vector v : patrol_101)
        {
            
            Print("^*^[UWUBUG]*^* ASSIGNED WAYPOINT TO BOT. patrol_101[" + w + "] = " + v);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
	void SpawnStuff()
	{
		...
		//vector cuck = {Math.RandomFloatInclusive(-50, -30.0), 0, Math.RandomFloatInclusive(-50.0, -30.0)};
       
        vector SoldierBotPos1 = MissionBuilding.ModelToWorld("-44 -11 -44");
